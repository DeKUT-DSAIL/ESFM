...
#SBATCH --job-name=train_ESFM_s_enc_KD_nm          # short name for the job
...
#SBATCH --account=a122
#SBATCH --output=logs/train_ESFM_s_enc_KD_nm%j.out  # output log file
...
srun --ntasks=$nnodes \
  ...
  bash -c '
    ...
    torchrun \
      ...
      train_encoder_KD.py \
        --config ./configs/config_ESFM_s_enc_KD_nm.yaml \
