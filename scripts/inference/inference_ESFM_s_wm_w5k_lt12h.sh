...
#SBATCH --job-name=inference_ESFM_s_wm_w5k_lt12h         # short name for the job
...
#SBATCH --account=a122
#SBATCH --output=logs/inference_ESFM_s_wm_w5k_lt12h%j.out  # output log file
  ...
  bash -c "
    ...
    torchrun \\
      ...
      inference_rollout.py \\
        --config ./configs/config_ESFM_s_wm_w5k_lt12h.yaml \
        2>&1
  "
