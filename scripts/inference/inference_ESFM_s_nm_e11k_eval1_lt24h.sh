...
#SBATCH --job-name=inference_ESFM_s_nm_e11k_eval1_lt24h         # short name for the job
...
#SBATCH --account=a122
#SBATCH --output=logs/inference_ESFM_s_nm_e11k_eval1_lt24h%j.out  # output log file
  ...
  bash -c "
    ...
    torchrun \\
      ...
      inference_rollout.py \\
        --config ./configs/config_ESFM_s_nm_e11k_lt24h.yaml \
        2>&1
  "
