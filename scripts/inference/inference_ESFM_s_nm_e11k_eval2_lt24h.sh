...
#SBATCH --job-name=inference_ESFM_s_nm_e11k_eval2_lt24h         # short name for the job
...
#SBATCH --exclusive
#SBATCH --time=1:30:00             # total run time (HH:MM:SS)
#SBATCH --account=a122
#SBATCH --output=logs/inference_ESFM_s_nm_e11k_eval2_lt24h%j.out  # output log file
  ...
  bash -c "
    ...
    torchrun \\
      ...
      inference_rollout.py \\
        --config ./configs/config_ESFM_s_nm_e11k_lt24h_ho.yaml \
        2>&1
  "
