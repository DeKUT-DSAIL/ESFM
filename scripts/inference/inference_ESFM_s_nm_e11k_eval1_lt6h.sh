...
#SBATCH --job-name=inference_ESFM_s_nm_e11k_eval1_lt6h         # short name for the job
...
#SBATCH --account=a122
#SBATCH --output=logs/inference_ESFM_s_nm_e11k_eval1_lt6h%j.out  # output log file
